...
typedef struct 
{
	...
	__IO uint32_t	CTRLB;			/**< \brief Offset: 0x04 (R/W 32) Control B */
	__IO uint32_t	PARAM;			/**< \brief Offset: 0x08 (R/W 32) NVM Parameter */
	__IO uint8_t	INTENCLR;		/**< \brief Offset: 0x0C (R/W  8) Interrupt Enable Clear */
		 RoReg8		Reserved2[0x3];
	__IO uint8_t	INTENSET;		/**< \brief Offset: 0x10 (R/W  8) Interrupt Enable Set */
		 RoReg8		Reserved3[0x3];
	__IO uint8_t	INTFLAG;		/**< \brief Offset: 0x14 (R/W  8) Interrupt Flag Status and Clear */
		 RoReg8		Reserved4[0x3];
	__IO uint16_t	STATUS;			/**< \brief Offset: 0x18 (R/W 16) Status */
		 RoReg8		Reserved5[0x2];
	__IO uint32_t	ADDR;			/**< \brief Offset: 0x1C (R/W 32) Address */
	__IO uint16_t	LOCK;			/**< \brief Offset: 0x20 (R/W 16) Lock Section */
} Nvmctrl;
