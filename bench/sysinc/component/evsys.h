...
#define EVSYS_USER_USER_Msk         (_U(0xF) << EVSYS_USER_USER_Pos)
...
#define EVSYS_USER_MASK             _U(0x0F0F)   /**< \brief (EVSYS_USER) MASK Register */
...
#define EVSYS_CHSTATUS_MASK         _U(0x0000FFFF) /**< \brief (EVSYS_CHSTATUS) MASK Register */
...
#define EVSYS_INTENCLR_MASK         _U(0x0000FFFF) /**< \brief (EVSYS_INTENCLR) MASK Register */
...
#define EVSYS_INTENSET_MASK         _U(0x0000FFFF) /**< \brief (EVSYS_INTENSET) MASK Register */
...
#define EVSYS_INTFLAG_MASK          _U(0x0000FFFF) /**< \brief (EVSYS_INTFLAG) MASK Register */
